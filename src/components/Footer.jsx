...
const Footer = () => {
	return (
		<footer className={footerclass['footer']}>
			<div className={footerclass['footer__container']}>
				{/* Company Info Section */}
				<div className={footerclass['footer__info']}>
					<div className={footerclass['footer__brand']}>
						<h2 className={footerclass['brand__title']}>Bisonte Industrial</h2>
						<p className={footerclass['brand__tagline']}>USA LLC</p>
					</div>
					
					<p className={footerclass['footer__description']}>
						Providing high-quality industrial solutions with excellence and reliability since 2020.
					</p>

					<div className={footerclass['footer__contact']}>
						<div className={footerclass['contact__item']}>
							<div className={footerclass['contact__icon']}>
								<MapPinIcon />
							</div>
							<div>
								<h4>Address</h4>
								<p>2452 Druid Hill Avenue<br />Baltimore, MD, 21217</p>
							</div>
						</div>
				...
				{/* Map Section */}
				<div className={footerclass['footer__map']}>
					<div className={footerclass['map__container']}>
						<iframe
						...
						/>
						<div className={footerclass['map__overlay']}>
							<span>📍 Visit Us</span>
						</div>
					</div>
				</div>
